...
def atualizar_clientes(lista_clientes):
    ...
    if cliente_para_atualizar:
        ...
        print(f"\nDados do cliente com email: {email_buscar} atualizados com sucesso!")
    else:
        print (f"\nCliente com email: {email_buscar} não encontrado.")  
...
def excluir_cliente(lista_clientes):
    ...
    cliente_para_remorer = encontrar_cliente_por_email(lista_clientes, nome_buscar)
